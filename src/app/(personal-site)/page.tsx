      ...
      <div className="grid border-spacing-2 gap-4 md:grid-cols-4">
        <div className="col-span-4 flex h-auto items-center justify-center md:col-span-2">
          <div className="h-full w-full">
            <span className="flex justify-center text-xl font-semibold underline underline-offset-4">
              About Me
            </span>
            <br />
            <p className="text-justify text-lg">
              ...
              recovery, I intend to hone my skills as a software engineer beyond
              my professional obligations, delving into personal projects and
              potential freelance opportunities.
              <br />
              <br />
              As I embark on this journey, I remain open to the opportunities
              and experiences that lie ahead, embracing the evolution of both my
              physical and professional pursuits.
            </p>
          </div>
        </div>
